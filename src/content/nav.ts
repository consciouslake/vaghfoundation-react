...
export const nav: Nav = {
  primary: [
    ...
    { label: 'Donate',       href: '/donate#donate-form', cta: true },
  ],
  mega: [
    ...
    { label: 'Contact',      href: '/contact#contact-form', desc: 'Reach us, locations, enquiries' },
    { label: 'Donate',       href: '/donate#donate-form', desc: 'Support our work with a contribution' },
  ],
  megaFooterLinks: [
